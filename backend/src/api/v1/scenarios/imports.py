...
lose a point. Bodies are typed as any JSON value rather than an object, so a
file that is a list or a string is named by the scenario checks instead of
failing request parsing with a generic error.
"""
