...
| Outage windows | ✅ several at once, drawn on the timeline strip — right-drag or the window button — with a gateway/satellite picker over each span (DECISIONS D13) |
